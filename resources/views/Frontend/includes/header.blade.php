            ...
            <div class="row align-items-center">
                <div class="col-6">
                    <div class="mobile-logo">
                        <a class="logo__dark" href="#"><img loading="lazy" src="{{asset('frontend')}}/img/logo/logo_1.png" alt="logo"></a>
                    </div>
                </div>
                <div class="col-6">
                                    ...
                                    <div class="header__right__dropdown__inner">
                                        <div class="single__header__right__dropdown">
                                            ...
                                            <div class="header__right__dropdown__img">
                                                <a href="#">
                                                    <img loading="lazy" src="{{asset('frontend')}}/img/grid/cart1.jpg" alt="photo">
                                                </a>
                                            </div>
                                        ...
                                        <div class="single__header__right__dropdown">
                                            ...
                                            <div class="header__right__dropdown__img">
                                                <a href="#">
                                                    <img loading="lazy" src="{{asset('frontend')}}/img/grid/cart2.jpg" alt="photo">
                                                </a>
                                            </div>
                                            <div class="header__right__dropdown__content">
                                        ...
                                        <div class="single__header__right__dropdown">
                                            ...
                                            <div class="header__right__dropdown__img">
                                                <a href="#">
                                                    <img loading="lazy" src="{{asset('frontend')}}/img/grid/cart3.jpg" alt="photo">
                                                </a>
                                            </div>
                                            <div class="header__right__dropdown__content">
                    ...
                    <ul class="mobile-menu">
                            ...
                            <ul class="dropdown">
                                ...
                                <li class="menu-item-has-children">
                                    <div class="mega__menu__img">
                                        <a href="#"><img loading="lazy" src="{{asset('frontend')}}/img/mega/mega_menu_2.png" alt="Mega Menu"></a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children "><a href="course.html">Courses</a>
                            ...
                            <ul class="dropdown">
                                ...
                                <li class="menu-item-has-children">
                                    <div class="mega__menu__img">
                                        <a href="#"><img loading="lazy" src="{{asset('frontend')}}/img/mega/mega_menu_1.png" alt="Mega Menu"></a>
                                    </div>
                                </li>
                            </ul>
                        </li>
